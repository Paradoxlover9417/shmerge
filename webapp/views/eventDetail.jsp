...
<br>
	<div class="wrap">
		<div class="inner container-fluid" >
			...
			<div id="map" style="max-width:600px; width:90%; height:300px;"></div> 
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          for (let i = 0; i < detail.length; i++) {
            ...
            $("#overview").html(dt.overview.replace(/<br\s*[\/]?>/gi, "\n").replace(/</g, "&lt;").replace(/>/g, "&gt;"));
      ...
      $.ajax({
          ...
          success: function(data2) {
            ...
            for (let i = 0; i < detail2.length; i++) {
              ...
              $("#playtime").html("<b>이용 시간:  </b><br>" + $("<span>").text(dt2.playtime).html().replace(/<br>/gi, '\r\n'));
              $("#usetimefestival").html("<b>입장료:  </b><br>" + $("<span>").text(dt2.usetimefestival).html().replace(/<br>/gi, '\r\n'));
