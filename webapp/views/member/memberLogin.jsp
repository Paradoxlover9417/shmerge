	...
	<div class="wrap">
		...
		<main class="form-signin w-100 text-center">
			<form id="loginform" method="post" action="MemberLoginOk.do"
				...
				<a class="kakaoLogin"
					href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=53907bf2cc99ddbb1929db25394e8fae&redirect_uri=http://localhost:8082/goSeoul/kakaoLogin.do">
