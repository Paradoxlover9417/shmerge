							...
							<li class="nav-item dropdown">
								...
								<ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item dropdown-submenu">
                                        <a class="dropdown-item" href="tripBoard2_form.do" role="button" aria-expanded="false"> 종류별 </a>
                                        <ul class="dropdown-menu">
									...
									<li class="dropdown-submenu">
                                        <a class="dropdown-item" href="tripBoard_form.do"> 지역별 </a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" href="gangseo_board.do">강서구</a></li>
